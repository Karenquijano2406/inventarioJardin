...
class ImprimirProductos {
    ...
    public function TraerProductos() {
        ...
        <h3 style="text-align:center;">Reporte de Entrada de Productos</h3>

        <!-- Maquetando la tabla con los datos para el PDF -->
        <table style="font-size:10px; padding:5px 10px;">
        <tr>
        <th style="border:1px solid #666; background-color:white; width:180px; font-size:12px; color:black; font-weight:bold;">Nombre Empresa</th>
        <th style="border:1px solid #666; background-color:white; width:200px; font-size:12px; color:black; font-weight:bold;">Tipo Empresa</th>
        <th style="border:1px solid #666; background-color:white; width:160px; font-size:12px; color:black; font-weight:bold;">Nombre Producto</th>
        <th style="border:1px solid #666; background-color:white; width:100px; font-size:12px; color:black; font-weight:bold;">Entrada</th>
