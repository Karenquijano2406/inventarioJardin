...
class ImprimirClientes {
    ...
    public function TraerClientes() {
        ...
        <th style="border:1px solid #666; background-color:white; width:100px; font-size:12px; color:black; font-weight:bold;">Nombre</th>
        <th style="border:1px solid #666; background-color:white; width:160px; font-size:12px; color:black; font-weight:bold;">Correo Electrónico</th>
        <th style="border:1px solid #666; background-color:white; width:100px; font-size:12px; color:black; font-weight:bold;">Teléfono</th>
        <th style="border:1px solid #666; background-color:white; width:150px; font-size:12px; color:black; font-weight:bold;">Dirección</th>
       <!--- <th style="border:1px solid #666; background-color:white; width:100px; font-size:12px; color:black; font-weight:bold;">Fecha de Registro</th> -->
        </tr>
        </table>';
