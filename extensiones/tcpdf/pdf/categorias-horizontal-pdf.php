...
class ImprimirCategorias {
    ...
    public function TraerCategorias() {
        ...
        <tr>
        <th style="border:1px solid #666; background-color:white; width:90px; font-size:12px; color:black; font-weight:bold;">id</th>
        <th style="border:1px solid #666; background-color:white; width:350px; font-size:12px; color:black; font-weight:bold;">Nombre</th>
        <th style="border:1px solid #666; background-color:white; width:350px; font-size:12px; color:black; font-weight:bold;">Fecha de Entrada</th>
        </tr>
        </table>';
