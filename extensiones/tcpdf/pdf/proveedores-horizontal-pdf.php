...
class ImprimirProveedores {
    ...
    public function TraerProveedores() {
        ...
        <th style="border:1px solid #666; background-color:white; width:150px; font-size:12px; color:black; font-weight:bold;">Empresa</th>
                <th style="border:1px solid #666; background-color:white; width:150px; font-size:12px; color:black; font-weight:bold;">Tipo de Empresa</th>
        <th style="border:1px solid #666; background-color:white; width:180px; font-size:12px; color:black; font-weight:bold;">Correo Electrónico</th>
        <th style="border:1px solid #666; background-color:white; width:100px; font-size:12px; color:black; font-weight:bold;">Teléfono</th>
        <th style="border:1px solid #666; background-color:white; width:170px; font-size:12px; color:black; font-weight:bold;">Dirección</th>
        </tr>
        </table>';
        ...
        foreach ($proveedores as $key => $valueDatos) {
        ...
        $pdf->Output('proveedores.pdf');
    }
}

$proveedores = new ImprimirProveedores();
