...
class ImprimirProductos {
    ...
    public function TraerProductos() {
        ...
        <tr>
        <th style="border:1px solid #666; background-color:white; width:120px; font-size:12px; color:black; font-weight:bold;">Categoría</th>
        <th style="border:1px solid #666; background-color:white; width:120px; font-size:12px; color:black; font-weight:bold;">Nombre</th>
        <th style="border:1px solid #666; background-color:white; width:120px; font-size:12px; color:black; font-weight:bold;">Descripción</th>
        <th style="border:1px solid #666; background-color:white; width:70px; font-size:12px; color:black; font-weight:bold;">Precio Compra</th>
        <th style="border:1px solid #666; background-color:white; width:60px; font-size:12px; color:black; font-weight:bold;">Precio Venta</th>
        <th style="border:1px solid #666; background-color:white; width:60px; font-size:12px; color:black; font-weight:bold;">Stock</th>
        </tr>
        </table>';
        ...
        foreach ($productos as $key => $valueDatos) {
            ...
            <td style="border:1px solid #666; background-color:white; width:60px;">$
