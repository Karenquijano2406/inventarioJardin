...
class ImprimirClientes {
    ...
    public function TraerClientes() {
        ...
        <th style="border:1px solid #666; background-color:white; width:150px; font-size:12px; color:black; font-weight:bold;">Nombre</th>
        ...
        <th style="border:1px solid #666; background-color:white; width:140px; font-size:12px; color:black; font-weight:bold;">Fecha de Registro</th>
        </tr>
        </table>';
