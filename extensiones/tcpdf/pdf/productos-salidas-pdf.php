...
class ImprimirProductos {
    ...
    public function TraerProductos() {
        ...
        <h3 style="text-align:center;">Reporte de Salidas de Productos</h3>
        ...
        <th style="border:1px solid #666; background-color:white; width:120px; font-size:12px; color:black; font-weight:bold;">Nombre del Producto</th>
        <th style="border:1px solid #666; background-color:white; width:120px; font-size:12px; color:black; font-weight:bold;">Nombre del Cliente</th>
        <th style="border:1px solid #666; background-color:white; width:70px; font-size:12px; color:black; font-weight:bold;">Salida</th>
        ...
        $pdf->Output('productosSalida.pdf');
    }
}
